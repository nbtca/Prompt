...
import type { MenuChoice, MenuAction } from "../types.js";

/**
 * Display the enhanced main menu with categories.
 */
export async function showMainMenu(): Promise<void> {
  const mainChoices: MenuChoice[] = [
 ...
 */
export async function showCategoryMenu(category: string, choices: MenuChoice[]): Promise<string> {
 ...
 * @returns User input.
 */
export async function showTextInput(message: string, defaultValue: string = ""): Promise<string> {
 ...
 * @param message - Password message.
 * @returns User password.
 */
export async function showPasswordInput(message: string): Promise<string> {
