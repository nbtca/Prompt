...
describe('renderSettings', () => {
  ...
  ])('fits a status message and action within seven rows and twenty columns', (statusMessage, label) => {
  ...
  it.each([
    ['Repository  github.com/nbtca/prompt-interface', 'Back'],
  ...
  it('keeps every about row scrollable while the back action starts visible', () => {
    const aboutLines = [
      ...
      'Repository  github.com/nbtca/prompt-interface',
      'Website  nbtca.space',
